...
optimizers = {
    ...
    'RMSprop': RMSprop(learning_rate=0.035),
    'SGD': SGD(learning_rate=0.035)
}
...
for optimizer_name, optimizer in optimizers.items():
    ...
    # Output layer
    model.add(Dense(y_train.shape[1]))  # Output shape based on number of responses
    ...
    print(f'Optimizer: {optimizer_name}, MSE: {mse}, R-squared: {r2}')
